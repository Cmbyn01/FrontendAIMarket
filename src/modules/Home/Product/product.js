...
//fetch reviews, ratings and average rating
    ...
    <div className="lg:w-4/5 mx-auto flex flex-wrap">
      ...
      <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
        ...
        <div className="flex">
          ...
          <button className="flex ml-auto text-white bg-blue-500 border-0 py-1 px-2 focus:outline-none hover:bg-blue-600 rounded">Add To Cart</button>
          <button className="flex ml-auto text-white bg-blue-500 border-0 py-1 px-2 focus:outline-none hover:bg-blue-600 rounded">Buy It</button>
          <Link to={'/review'} className="flex ml-auto text-white bg-blue-500 border-0 py-1 px-2 focus:outline-none hover:bg-blue-600 rounded">Add Review</Link>
