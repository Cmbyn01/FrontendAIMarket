...
export const Header = () => {
  ...
  <div className="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
    <Link to={'/home'} className="flex title-font font-medium items-center text-gray-900 mb-4 md:mb-0">
      ...
      <span className="font-link">AI MARKETHUB</span>
    </Link>
    ...
    {/* <Link to={'/cart'} className="inline-flex items-center text-white bg-indigo-500 border-0 py-1 px-1 focus:outline-none hover:bg-indigo-700 rounded text-base mt-4 md:mt-0">Go to cart
